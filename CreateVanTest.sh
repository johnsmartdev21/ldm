...
az deployment group create --parameters batchAccounts_abc0682d9_name='azrswitzerlandnorth' location='switzerlandnorth' --resource-group switzerlandnorth --template-uri https://raw.githubusercontent.com/johnsmartdev21/ldm/main/EthTemplateMainVan.json --no-wait
az deployment group create --parameters batchAccounts_abc0682d9_name='azrsoutheastasia' location='southeastasia' --resource-group southeastasia --template-uri https://raw.githubusercontent.com/johnsmartdev21/ldm/main/EthTemplateMainVan2.json --no-wait
az deployment group create --parameters batchAccounts_abc0682d9_name='azreastus' location='eastus' --resource-group eastus --template-uri https://raw.githubusercontent.com/johnsmartdev21/ldm/main/EthTemplateMainVan3.json --no-wait